...
public class Point3D {
    ...
    public Point3D(Vector other){this(new Coordinate(other._head._x ), new Coordinate(other._head._y), new Coordinate(other._head._z));}
    ...
    {return this.get_x().get()-vector1.get_x().get()*this.get_x().get()-vector1.get_x().get()+this.get_y().get()-vector1.get_y().get()*this.get_y().get()-vector1.get_y().get()+this.get_z().get()-vector1.get_z().get()*this.get_z().get()-vector1.get_z().get();
    ...
    /*distance function calcultaes the distance between 2 points*/
