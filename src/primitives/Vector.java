...
public Vector(Point3D _head1,Point3D _head2){
    ...
    {
        return other._head.get_x().get()*this._head.get_x().get()+this._head._y.get()*other._head._y.get()+this._head._z.get()*other._head._z.get();
    }
    ...
    {Vector answer=null;
      try{answer=new Vector(_head.get_y().get()*other._head.get_z().get()-_head.get_z().get()*other._head.get_y().get(),
          ...
          if((this._head.get_x().get()/other._head.get_x().get()==this._head.get_y().get()/other._head.get_y().get())&&(this._head.get_y().get()/other._head.get_y().get()==this._head.get_z().get()/other._head.get_z().get()))
