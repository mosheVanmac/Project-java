...
public class LightsTests {
    ...
    public void sphereSpot() {
        ...
        scene.addLights(new SpotLight(new Color(500, 300, 0), new Point3D(-50, 50, -50),
                0.00000001,  1, 0.00001, new Vector(1, -1, 2)));
    ...
    public void trianglesDirectional() {
        ...
        scene.addGeometries(
                new Triangle(new Material(0.8, 0.2, 300),new Point3D(-150, 150, 150),
                        ...
                        new Point3D(75, -75, 150),Color.BLACK));
                new Triangle( new Material(0.8, 0.2, 300),
                        new Point3D(-150, 150, 150), new Point3D(-70, -70, 50),
                        new Point3D(75, -75, 150),Color.BLACK);
    ...
    public void trianglesSpot() {
        ...
        scene.addLights(new SpotLight(new Color(500, 250, 250),
                new Point3D(10, 10, 130),0.000005 ,
                1, 0.0001, new Vector(-2,2,1)));
